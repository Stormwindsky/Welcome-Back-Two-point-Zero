...
/*    */ 
/*    */ public class CowHorseEntity extends Cow {
/*    */   public CowHorseEntity(EntityType<CowHorseEntity> type, Level world) {
/* 33 */     super(type, world);
...
/* 61 */     spawnAtLocation(new ItemStack((ItemLike)Items.LEATHER));
/*    */   }
/*    */ 
/*    */   
/*    */   public SoundEvent getAmbientSound() {
/* 66 */     return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.cow.ambient"));
/*    */   }
/*    */ 
/*    */   
/*    */   public void playStepSound(BlockPos pos, BlockState blockIn) {
/* 71 */     playSound((SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.cow.step")), 0.15F, 1.0F);
/*    */   }
/*    */ 
/*    */   
/*    */   public SoundEvent getHurtSound(DamageSource ds) {
/* 76 */     return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.cow.hurt"));
/*    */   }
/*    */ 
/*    */   
/*    */   public SoundEvent getDeathSound() {
/* 81 */     return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.cow.death"));
/*    */   }
/*    */   
/*    */   public static void init() {
/* 85 */     SpawnPlacements.register((EntityType)ReturnToExclusiveMobsModEntities.COW_HORSE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> 
...
/* Location:              /home/stormwindsky/Téléchargements/welcome-back-two-point-zero-1.0.0-neoforge-1.20.4.jar!/net/mcreator/welcomebackhorsetwopointzero/entity/CowHorseEntity.class
